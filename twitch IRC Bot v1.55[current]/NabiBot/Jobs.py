...
SecondTier = ["Lumberjack", "Soldier", "Librarian", "Teacher", "Server", "Actor", "Miko", "Gangster", "Alchemist", "Greater_Demon", "Mercenary", "Mason", "Translator", "Trader"]
ThirdTier = ["Fisherman", "Captain", "Accountant", "Researcher", "Culinary_Attendant", "Dancer", "Priest", "Assassin", "Mage", "Elite_Demon", "Freelancer", "Blacksmith", "Judge", "Innkeeper"]
FourthTier = ["Hunter", "General", "Advisor", "Time_Traveler", "Chef", "Idol", "Oracle", "Executioner", "Summoner", "Demon_Lord", "Hero", "Craftsman", "Supreme_Justice", "Banker"]
...
class Occupation(object):
	...
	def checkJobUp(self, requirement):
		if requirement == None:
			...
			log("type error in rank up requirements")
			return False
...
class Scavenger(Occupation):
	def __init__(self, exp = 0, level = 0, CSQ = [], Icur = 0, Ecur = 0, ILOW = 5, IUP = 11, ELOW = 1, EUP = 6):
		Occupation.__init__(self, exp, level, CSQ, Icur, Ecur, ILOW, IUP, ELOW, EUP)
		self.name = "Scavenger"
		self.rankUpReq = [8, "ScavengerFinal"]
		self.Squests = []
		self.Cquests = []
		self.Events = ["ScavengerE1", "ScavengerE2", "ScavengerE3", "ScavengerE4"]
...
class Writer(Occupation):
	def __init__(self, exp = 0, level = 0, CSQ = [], Icur = 0, Ecur = 0, ILOW = 5, IUP = 11, ELOW = 1, EUP = 6):
		...
		self.Squests = []
		self.Cquests = []
		self.Events = ["WriterE1", "WriterE2", "WriterE3"]
...
#Student->Teacher->Researcher->Time_Traveler
class Student(Occupation):
	def __init__(self, exp = 0, level = 0, CSQ = [], Icur = 0, Ecur = 0, ILOW = 7, IUP = 16, ELOW = 3, EUP = 11):
		...
		self.Squests = []
		self.Cquests = []
		self.Events = ["StudentE1", "StudentE2", "StudentE3"]
...
class Teacher(Occupation):
	def __init__(self, exp = 0, level = 0, CSQ = [], Icur = 0, Ecur = 0, ILOW = 7, IUP = 16, ELOW = 3, EUP = 11):
		Occupation.__init__(self, exp, level, CSQ, Icur, Ecur, ILOW, IUP, ELOW, EUP)
		self.name = "Teacher"
		self.rankUpReq = [14, "TeacherFinal"]
		self.Squests = []
		self.Cquests = []
		self.Events = []
		self.NextJob = "Researcher"

class Researcher(Occupation):
	def __init__(self, exp = 0, level = 0, CSQ = [], Icur = 0, Ecur = 0, ILOW = 10, IUP = 21, ELOW = 7, EUP = 16):
		Occupation.__init__(self, exp, level, CSQ, Icur, Ecur, ILOW, IUP, ELOW, EUP)
		self.name = "Researcher"
		self.rankUpReq = [14, "ResearcherFinal"]
		self.Squests = []
		self.Cquests = []
		self.Events = []
		self.NextJob = "Time_Traveler"

class Time_Traveler(Occupation):
	def __init__(self, exp = 0, level = 0, CSQ = [], Icur = 0, Ecur = 0, ILOW = 7, IUP = 16, ELOW = 3, EUP = 11):
		Occupation.__init__(self, exp, level, CSQ, Icur, Ecur, ILOW, IUP, ELOW, EUP)
		self.name = "Time_Traveler"
		self.Squests = []
		self.Cquests = []
		self.Events = []	
...
class Bartender(Occupation):
	def __init__(self, exp = 0, level = 0, CSQ = [], Icur = 0, Ecur = 0, ILOW = 7, IUP = 16, ELOW = 3, EUP = 11):
		...
		self.Squests = []
		self.Cquests = []
		self.Events = ["BartenderE1", "BartenderE2", "BartenderE3"]
		self.NextJob = "Server"
...
class Street_Performer(Occupation):
	def __init__(self, exp = 0, level = 0, CSQ = [], Icur = 0, Ecur = 0, ILOW = 5, IUP = 11, ELOW = 1, EUP = 6):
		...
		self.Squests = []
		self.Cquests = []
		self.Events = ["Street_PerformerE1", "Street_PerformerE2", "Street_PerformerE3"]
		self.NextJob = "Actor"
...
class Apprentice(Occupation):
	def __init__(self, exp = 0, level = 0, CSQ = [], Icur = 0, Ecur = 0, ILOW = 5, IUP = 11, ELOW = 1, EUP = 6):
		...
		self.Squests = []
		self.Cquests = []
		self.Events = ["ApprenticeE1", "ApprenticeE2", "ApprenticeE3"]
		self.NextJob = "Miko"
...
class Thief(Occupation):
	def __init__(self, exp = 0, level = 0, CSQ = [], Icur = 0, Ecur = 0, ILOW = 7, IUP = 16, ELOW = 1, EUP = 6):
		...
		self.Squests = []
		self.Cquests = []
		self.Events = ["ThiefE1", "ThiefE2", "ThiefE3"]
...
class Outsider(Occupation):
	def __init__(self, exp = 0, level = 0, CSQ = [], Icur = 0, Ecur = 0, ILOW = 5, IUP = 11, ELOW = 3, EUP = 11):
		...
		self.Squests = []
		self.Cquests = []
		self.Events = ["OutsiderE1", "OutsiderE2", "OutsiderE3"]
		self.NextJob = "Alchemist"
		
class Alchemist(Occupation):
	def __init__(self, exp = 0, level = 0, CSQ = [], Icur = 0, Ecur = 0, ILOW = 5, IUP = 11, ELOW = 3, EUP = 11):
		Occupation.__init__(self, exp, level, CSQ, Icur, Ecur, ILOW, IUP, ELOW, EUP)
		self.name = "Alchemist"
		self.rankUpReq = [17, "AlchemistFinal"]
		self.Squests = []
		self.Cquests = []
		self.Events = []
		self.NextJob = "Mage"

class Mage(Occupation):
	def __init__(self, exp = 0, level = 0, CSQ = [], Icur = 0, Ecur = 0, ILOW = 15, IUP = 26, ELOW = 7, EUP = 16):
		Occupation.__init__(self, exp, level, CSQ, Icur, Ecur, ILOW, IUP, ELOW, EUP)
		self.name = "Mage"
		self.rankUpReq = [17, "MageFinal"]
		self.Squests = []
		self.Cquests = []
		self.Events = []
...
class Lesser_Demon(Occupation):
	def __init__(self, exp = 0, level = 0, CSQ = [], Icur = 0, Ecur = 0, ILOW = 7, IUP = 16, ELOW = 1, EUP = 6):
		...
		self.Squests = []
		self.Cquests = []
		self.Events = ["Lesser_DemonE1", "Lesser_DemonE2", "Lesser_DemonE3"]
...
class Adventurer(Occupation):
	def __init__(self, exp = 0, level = 0, CSQ = [], Icur = 0, Ecur = 0, ILOW = 10, IUP = 21, ELOW = 7, EUP = 16):
		...
		self.Squests = []
		self.Cquests = []
		self.Events = ["AdventurerE1", "AdventurerE2", "AdventurerE3"]
...
class Mechanic(Occupation):
	def __init__(self, exp = 0, level = 0, CSQ = [], Icur = 0, Ecur = 0, ILOW = 10, IUP = 21, ELOW = 7, EUP = 16):
		...
		self.Squests = []
		self.Cquests = []
		self.Events = ["MechanicE1", "MechanicE2", "MechanicE3"]
		self.NextJob = "Mason"
...
class Linguist(Occupation):
	def __init__(self, exp = 0, level = 0, CSQ = [], Icur = 0, Ecur = 0, ILOW = 10, IUP = 21, ELOW = 7, EUP = 16):
		...
		self.Squests = []
		self.Cquests = []
		self.Events = ["LinguistE1", "LinguistE2", "LinguistE3"]
...
class Peddler(Occupation):
	def __init__(self, exp = 0, level = 0, CSQ = [], Icur = 0, Ecur = 0, ILOW = 5, IUP = 11, ELOW = 11, EUP = 21):
		...
		self.Squests = []
		self.Cquests = []
		self.Events = ["PeddlerE1", "PeddlerE2", "PeddlerE3"]
		self.NextJob = "Trader"
