...
class Newbie(Standing):
	def __init__(self):
		...
		self.restrictions = ["debug.crash()", "NPChange()", "Occupation.oChange()", "Standings.change()", "debug.exit()","coin.add()","coin.remove()","coin.set()","Nabi.ExpressionList()","dummy.add()","dummy.remove()","Osu.skin()","coin.shop()"]
...
class Fledgling(Standing):
	def __init__(self):
		...
		self.restrictions = ["debug.crash()", "NPChange()", "Occupation.oChange()", "Standings.change()", "debug.exit()","coin.add()","coin.remove()","coin.set()","Nabi.ExpressionList()","dummy.add()","dummy.remove()"]
...
class CommonFace(Standing):
	def __init__(self):
		...
		self.restrictions = ["debug.crash()", "NPChange()", "Occupation.oChange()", "Standings.change()", "debug.exit()","coin.add()","coin.remove()","coin.set()","dummy.add()","dummy.remove()"]
...
class NoLifer(Standing):
	def __init__(self):
		...
		self.restrictions = ["debug.crash()", "Occupation.oChange()", "Standings.change()", "debug.exit()","coin.add()","coin.remove()","coin.set()"]
...
class SpecialPerson(Standing):
	def __init__(self):
		...
		self.reqLevel = 9999999999999999999999999999999999999999999999999999999999999999999999999
