...
class Newbie(Standing):
	def __init__(self):
		...
		self.restrictions = ["dubug.crash()", "NPChange()", "Occupation.oChange()", "Standings.change()", "debug.exit()","coin.add()","coin.remove()","coin.set()","Nabi.ExpressionList()","dummy.add()","dummy.remove()","Osu.skin()","coin.shop()"]
...
class Fledgling(Standing):
	def __init__(self):
		...
		self.restrictions = ["dubug.crash()", "NPChange()", "Occupation.oChange()", "Standings.change()", "debug.exit()","coin.add()","coin.remove()","coin.set()","Nabi.ExpressionList()","dummy.add()","dummy.remove()"]
